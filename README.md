...
完整安裝檔請至 [OpenCam v0.1.3 Release](https://github.com/kaoshou/OpenCam/releases/tag/v0.1.3) 下載。
...
Download the installers from the [OpenCam v0.1.3 Release](https://github.com/kaoshou/OpenCam/releases/tag/v0.1.3).
...
> OpenCam v0.1.3 does not provide an Intel Mac (x64) build.
