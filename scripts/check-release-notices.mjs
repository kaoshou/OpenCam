...
export async function verifyReleaseNotices(directory, revision, version) {
...
if (process.argv[1] && import.meta.url === pathToFileURL(resolve(process.argv[1])).href) {
  const [, , directory, revision, version] = process.argv;
  await verifyReleaseNotices(directory, revision, version);
